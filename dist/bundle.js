...
/* harmony import */ var _components_Context__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(18);
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ReactReduxContext", function() { return _components_Context__WEBPACK_IMPORTED_MODULE_2__["ReactReduxContext"]; });

/* harmony import */ var _connect_connect__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(27);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(15);
...
/* harmony import */ var _Context__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(18);
...
/* harmony import */ var _babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(15);
/* harmony import */ var _babel_runtime_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(20);
/* harmony import */ var _babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(21);
/* harmony import */ var _babel_runtime_helpers_esm_objectWithoutPropertiesLoose__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(22);
/* harmony import */ var hoist_non_react_statics__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(23);
/* harmony import */ var hoist_non_react_statics__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(hoist_non_react_statics__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var invariant__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(26);
...
/* harmony import */ var react_is__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(24);
...
/* harmony import */ var _Context__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(18);
...
/* harmony import */ var _utils_shallowEqual__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(28);
/* harmony import */ var _mapDispatchToProps__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(29);
/* harmony import */ var _mapStateToProps__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(38);
/* harmony import */ var _mergeProps__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(39);
/* harmony import */ var _selectorFactory__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(40);
...
/* harmony import */ var _wrapMapToProps__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(34);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(global, module) {/* harmony import */ var _ponyfill_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(33);
/* global window */
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(10), __webpack_require__(32)(module)))
...
/* harmony import */ var _isPlainObject__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(36);
/* harmony import */ var _warning__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(37);
...
/* harmony import */ var _wrapMapToProps__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(34);
...
/* harmony import */ var _babel_runtime_helpers_esm_objectWithoutPropertiesLoose__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(22);
/* harmony import */ var _verifySubselectors__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(41);
...
/* harmony import */ var _utils_warning__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(37);
...
var _ChefForm = __webpack_require__(43);

var _ChefForm2 = _interopRequireDefault(_ChefForm);

var _SigninButton = __webpack_require__(45);

var _SigninButton2 = _interopRequireDefault(_SigninButton);

var _TasteeForm = __webpack_require__(47);

var _TasteeForm2 = _interopRequireDefault(_TasteeForm);

var _Slider = __webpack_require__(48);

var _Slider2 = _interopRequireDefault(_Slider);

var _InfoWindowContent = __webpack_require__(49);

var _TestEvents = __webpack_require__(50);
  ...
  _createClass(App, [{
    ...
    value: function addMarker(info) {
      if (this.markers[info.id] === undefined) {
        ...
        var description = (0, _InfoWindowContent.InfoWindowContent)(info, this.state.toggle, this.subscribe.bind(this));
    ...
    key: 'addPostingMarker',
    value: function addPostingMarker(info) {
      var map = this.state.map;
      var marker = new google.maps.Marker({
      ...
      var description = (0, _InfoWindowContent.InfoWindowContent)(this.state.user.givenName + ' ' + this.state.user.familyName, info);
      var infoWindow = new google.maps.InfoWindow({
        content: description,
        maxWidth: 200
      });
    ...
    value: function toggle() {
      var toggle = this.state.toggle === 'chef' ? 'tastee' : 'chef';
      var _iteratorNormalCompletion = true;
      var _didIteratorError = false;
      var _iteratorError = undefined;

      try {
        for (var _iterator = Object.keys(this.markers)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var key = _step.value;
    ...
    key: 'sendData',
    value: function sendData(info) {
      var post = Object.assign({}, this.state.user);
    ...
    key: 'distance',
    value: function distance(locationA, locationB) {
    ...
    value: function populateMap() {
      ...
      try {
        for (var _iterator2 = _TestEvents.events[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
          var event = _step2.value;

          if (this.distance(this.state.currentLocation, event.currentLocation) <= this.state.radius) this.addMarker(event);else {
    ...
    key: 'updateRadius',
    value: function updateRadius(slider) {
    ...
    key: 'toggleSignIn',
    value: function toggleSignIn(response) {
      var loggedIn = this.state.loggedIn === true ? false : true;
      var map = this.state.map;
      var user = null;
      if (loggedIn === true) {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { id: 'left' },
            _react2.default.createElement('img', { className: 'logo', src: '/img/logo.jpg', alt: 'logo' })
          ),
          _react2.default.createElement(
            'div',
            { id: 'right' },
            ...
            _react2.default.createElement(_SigninButton2.default, {
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { id: 'content-right' },
            _react2.default.createElement(_ChefForm2.default, {
              user: this.state.user,
              loggedIn: this.state.loggedIn,
              toggle: this.state.toggle,
              addPostingMarker: this.addPostingMarker.bind(this)
            }),
            _react2.default.createElement(_TasteeForm2.default, {
              loggedIn: this.state.loggedIn,
              map: this.map,
              toggle: this.state.toggle
            })
...
var _SubscribersList = __webpack_require__(44);

var _SubscribersList2 = _interopRequireDefault(_SubscribersList);
...
var ChefForm = function (_Component) {
  _inherits(ChefForm, _Component);

  function ChefForm(props) {
    _classCallCheck(this, ChefForm);

    var _this = _possibleConstructorReturn(this, (ChefForm.__proto__ || Object.getPrototypeOf(ChefForm)).call(this, props));

    _this.state = { description: '', time: '', title: '', capacity: 0 };
    ...
    _this.handleCapacityChange = _this.handleCapacityChange.bind(_this);
    _this.handleTitleChange = _this.handleTitleChange.bind(_this);
    _this.handleOnSubmit = _this.handleOnSubmit.bind(_this);
    return _this;
  }

  _createClass(ChefForm, [{
    ...
    value: function handleCapacityChange(e) {
      var capacity = Math.min(e.target.value, LIMIT);
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'div',
              { id: 'chef-img' },
              _react2.default.createElement('img', { src: this.props.user.imageUrl })
            ),
            _react2.default.createElement(
              'div',
              { id: 'chef-bio' },
              ...
              _react2.default.createElement(
                'h2',
                { id: 'chef-joined' },
                'Has been cooking for 5 weeks.'
              ),
              _react2.default.createElement(
                'h3',
                { id: 'chef-total' },
                'Cooked and served a total of ',
                _react2.default.createElement(
                  'strong',
                  null,
                  '15'
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(_SubscribersList2.default, {
...
var names = ['Bob', 'Evan', 'James'];

var SubscribersList = function (_Component) {
  _inherits(SubscribersList, _Component);

  function SubscribersList(props) {
    _classCallCheck(this, SubscribersList);

    return _possibleConstructorReturn(this, (SubscribersList.__proto__ || Object.getPrototypeOf(SubscribersList)).call(this, props));
  }

  _createClass(SubscribersList, [{
    key: 'renderList',
...
var SigninButton = function (_Component) {
  ...
  function SigninButton(props) {
    ...
    return _possibleConstructorReturn(this, (SigninButton.__proto__ || Object.getPrototypeOf(SigninButton)).call(this, props));
  }
  ...
  _createClass(SigninButton, [{
    ...
    value: function render() {
      ...
      } else return _react2.default.createElement(_reactGoogleLogin.GoogleLogout, {
        buttonText: 'Logout',
...
var TasteeForm = function (_Component) {
  _inherits(TasteeForm, _Component);

  function TasteeForm(props) {
    _classCallCheck(this, TasteeForm);

    var _this = _possibleConstructorReturn(this, (TasteeForm.__proto__ || Object.getPrototypeOf(TasteeForm)).call(this, props));

    _this.state = { description: '', slider: 1, capacity: 0 };
    _this.handleDescriptionChange = _this.handleDescriptionChange.bind(_this);
    _this.handleOnSubmit = _this.handleOnSubmit.bind(_this);
    return _this;
  }

  _createClass(TasteeForm, [{
    key: 'handleDescriptionChange',
    value: function handleDescriptionChange(e) {
      this.setState({ description: e.target.value });
    }
...
var Slider = function (_Component) {
  ...
  _createClass(Slider, [{
    ...
    value: function handleSliderChange(e) {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            "Search Distance ",
            this.state.slider * this.props.UNITS,
            " km"
          ),
          _react2.default.createElement("input", {
            type: "range",
...
exports.InfoWindowContent = undefined;
...
var InfoWindowContent = exports.InfoWindowContent = function InfoWindowContent(event, toggle, subscribe) {
  var description = document.createElement('div');
  var button = void 0;
  var name = event.givenName + ' ' + event.familyName;
  var htmlTemplate = '\n  <h1 class=\'event-host\'>Chef: ' + name + '</h1>\n  <h2 class=\'event-title\'>Title: ' + event.title + '</h2\n  <h3 class=\'event-description\'>Description: ' + event.description + '</h3>\n  <h4 class=\'event-time\'>Time:' + event.time + '</h4>\n  <h5 class=\'event-capacity\'>Willing to host up to <strong>' + event.capacity + '</strong> tastees</h5>\n  <h5 class=\'event-contact\'>Contact: ' + event.email + ' </h5>\n  ';
...
var events = exports.events = [{
  ...
  familyName: 'Hon',
  title: 'title1',
  description: 'Hello everyone. I will be preparing an excquisite steak dinner with wine. Come on over and taste what the chef is cooking',
  time: '2:34 PM',
  currentLocation: { lat: 40.72227, lon: -74.000723 },
  ...
  familyName: 'Choy',
  title: 'title2',
  description: 'Hello everyone. I am making a big pizza. Come and get it!',
  time: '3:10 PM',
  currentLocation: { lat: 40.722033, lon: -73.997242 },
  email: 'sample@gmail.com',
  capacity: 2
}, {
  id: 2032,
  ...
  familyName: 'Chen',
  title: 'title3',
  description: 'White cupcakes with a chocolate egg in the center, thick, colorful icing, and topped with a chocolate mini egg!!! Great Easter treat!!',
  time: '7:34 PM',
  currentLocation: { lat: 40.7227, lon: -73.998857 },
  email: 'sample@gmail.com',
  capacity: 4
}, {
  id: 2423,
  ...
  description: 'Pasta',
  time: '7:34 PM',
  currentLocation: { lat: 40.642309, lon: -73.946436 },
  email: 'sample@gmail.com',
  capacity: 10
}, {
  id: 3231,
  ...
  description: 'Pasta',
  time: '7:34 PM',
  currentLocation: { lat: 40.760798, lon: -73.989396 },
  email: 'sample@gmail.com',
  capacity: 3
}, {
  id: 3523,
  ...
  description: 'Pasta',
  time: '7:34 PM',
  currentLocation: { lat: 40.72503, lon: -74.004741 },
  email: 'sample@gmail.com',
  capacity: 1
}, {
  id: 4523,
  ...
  description: 'Pasta',
  time: '7:34 PM',
  currentLocation: { lat: 40.73224, lon: -73.977265 },
  email: 'sample@gmail.com',
  capacity: 6
}];
